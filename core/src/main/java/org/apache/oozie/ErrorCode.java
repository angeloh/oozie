...
public enum ErrorCode {
    ...
    E0810(XLog.STD, "Job state is not [{0}]. Skipping ActionEnd Execution"),
    E0811(XLog.STD, "Action pending=[{0}], status=[{1}]. Skipping ActionEnd Execution"),
    E0812(XLog.STD, "Workflow not RUNNING, current status [{0}]"),
    E0813(XLog.STD, "SignalCommand for action id=[{0}] is already processed, status=[{1}], , pending=[{2}]"),
